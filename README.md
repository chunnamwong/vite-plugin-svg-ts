...
- [SvelteKit](https://github.com/chunnamwong/vite-plugin-svg-ts/tree/main/examples/svelte#sveltekit-setup)
- [Waku (with RSC)](https://github.com/chunnamwong/vite-plugin-svg-ts/blob/main/examples/waku/README.md#waku-setup)
