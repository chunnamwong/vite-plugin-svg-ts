...
- [SvelteKit](https://github.com/chunnamwong/vite-plugin-svg-ts/tree/main/examples/svelte)
- [Waku (with RSC)](https://github.com/chunnamwong/vite-plugin-svg-ts/tree/main/examples/waku)
